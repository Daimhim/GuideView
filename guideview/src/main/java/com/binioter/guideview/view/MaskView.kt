...
class MaskView
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until mTargetRects.size()) {
            ...
            valueAt.rect.set(Common.getViewAbsRect(valueAt.view,
                    mOverlayRect.left.toInt(), mOverlayRect.top.toInt()))
//            valueAt.rect.top -= mOverlayRect.top.toInt()
//            valueAt.rect.bottom -= mOverlayRect.top.toInt()
        }
    }
